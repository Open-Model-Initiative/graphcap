...
from .types import DatasetMetadata, HfUploadManifestConfig
...
def dataset_metadata(context: dg.AssetExecutionContext) -> DatasetMetadata:
    ...
    return DatasetMetadata(
        ...
        dataset_description="A dataset generated by graphcap.",
        dataset_tags=["image-captioning", "computer-vision"],
    )
...
def huggingface_upload_manifest(
    ...
    Args:
        ...
        dataset_export_manifest (dg.MaterializeResult): Result from manifest dataset export (provides
            export_dir and manifest_path).
