...
function ImageComponent({
	...
	const cssAspectRatio = forceContainerAspect
		? formatAspectRatioForCSS(aspectRatio)
		: undefined;
...
export function ResponsiveImage(props: ResponsiveImageProps) {
	const cssAspectRatio = props.forceContainerAspect
		? formatAspectRatioForCSS(props.aspectRatio)
		: undefined;
