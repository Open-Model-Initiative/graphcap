...
export const errorToast = (text: string, options?: Parameters<typeof toast.error>[1]) => {
  console.error(text);
  if (text != null && text !== "") {
...
export const successToast = (text: string, options?: Parameters<typeof toast.success>[1]) => {
  if (text != null && text !== "") {
