 ...
 */
export function GenerationOptionsIcon({ className = "" }: Readonly<IconProps>) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
			...
			width="20"
			height="20"
			aria-labelledby="generationOptionsIconTitle"
		>
			<title id="generationOptionsIconTitle">Generation Options</title>
