...
export function useSyncDatasetWithGallery() {
  ...
  useEffect(() => {
    if (galleryContext.selectedDataset && galleryContext.selectedDataset !== datasetContext.currentDataset) {
  ...
  useEffect(() => {
    if (datasetContext.currentDataset && datasetContext.currentDataset !== galleryContext.selectedDataset) {
