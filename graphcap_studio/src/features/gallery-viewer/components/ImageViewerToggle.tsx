 ...
 * 
 * @deprecated Use ViewModeToggle instead. This component will be removed in a future release.
 * 
...
export function ImageViewerToggle({
  ...
  if (process.env.NODE_ENV !== 'production') {
    console.warn(
      'ImageViewerToggle is deprecated and will be removed in a future release. ' +
      'Please use ViewModeToggle instead.'
    );
  }
  
  return (
    <div className={`flex rounded-md ${className} ${disabled ? 'opacity-50' : ''}`}>
      <button
        ...
        style={{
          boxShadow: viewMode === 'grid' ? 'inset 0 0 0 1px rgba(99, 102, 241, 0.6), 0 0 0 1px rgba(99, 102, 241, 0.4)' : 'none'
        }}
      >
      ...
      <button
        ...
        style={{
          boxShadow: viewMode === 'carousel' ? 'inset 0 0 0 1px rgba(99, 102, 241, 0.6), 0 0 0 1px rgba(99, 102, 241, 0.4)' : 'none'
        }}
      >
        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
