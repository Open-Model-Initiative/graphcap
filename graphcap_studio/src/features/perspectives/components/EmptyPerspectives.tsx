  ...
  return (
    <Center py={8}>
      <Stack direction="column" gap={2} align="center" textAlign="center">
        ...
        <Text fontWeight="medium" fontSize="sm">No perspectives available</Text>
        <Text fontSize="xs" color={textColor}>Perspectives will appear here when they are loaded</Text>
      </Stack>
    </Center>
  );
} 