...
import { Box, Text, Stack, Heading, Badge } from '@chakra-ui/react';
...
function DataItem({ label, value, isBadge = false, labelColor, valueColor }: DataItemProps) {
  return (
    <Box display="flex" justifyContent="space-between">
      ...
      {isBadge ? (
        ...
        <Text fontSize="xs" color={valueColor}>{value}</Text>
      )}
    </Box>
  );
} 