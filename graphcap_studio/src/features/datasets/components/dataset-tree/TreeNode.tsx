...
import { TreeContextMenu, HamburgerMenuButton } from "./TreeContextMenu"
...
export function TreeNode({
  ...
  const handleNodeClick = (e: React.MouseEvent) => {
    const isChevronClick = (e.target as HTMLElement).closest('.tree-chevron') !== null;
    const isMenuButtonClick = (e.target as HTMLElement).closest('.menu-button') !== null;
