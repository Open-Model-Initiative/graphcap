  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="w-full max-w-md rounded-lg bg-gray-800 p-6 shadow-xl">
        <h2 className="mb-4 text-xl font-semibold text-white">Delete Dataset</h2>
        
        <p className="mb-6 text-gray-300">
          Are you sure you want to delete the dataset <span className="font-semibold text-white">{datasetName}</span>?
          This action cannot be undone and all images in this dataset will be permanently deleted.
        </p>
