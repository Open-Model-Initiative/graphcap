...
export const CSS_CLASSES = {
  ...
  // Container styling
  CONTAINER: {
    HEADER: 'p-2 bg-gray-50 dark:bg-gray-800 border-b border-gray-300 dark:border-gray-700 text-xs font-medium',
    CONTENT: 'p-2 max-h-96 overflow-y-auto bg-white dark:bg-gray-900',
    BORDER: 'border rounded border-gray-300 dark:border-gray-700 overflow-hidden',
  },
  // Button styling
  BUTTON: {
  ...
  // Error message
  ERROR: {
    CONTAINER: 'mb-4 p-2 bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200 rounded',
  },
};
...
export const FILE_EXTENSIONS = {
  ...
  CODE: ['js', 'jsx', 'ts', 'tsx', 'py', 'java', 'c', 'cpp', 'h', 'html', 'css', 'scss'],
